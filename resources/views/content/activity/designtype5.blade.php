			...
			<form class="form-horizontal" id="myForm">
				...
				<div class="form-group">
					...
					<div class="col-xs-1">
						<div class="checkbox">
              <label>
                <input type="checkbox" id="inOptionChk1" value="0" onchange="markCorrectIncorrectOption(this)"
					...
					<div class="col-xs-8">
						<form id="imageForm1">
							<input type="file" name="imagefield" id="imageId1" accept="image/*">
				...
				<div class="form-group">
					...
					<div class="col-xs-1">
						<div class="checkbox">
              <label>
                <input type="checkbox" id="inOptionChk2" value="1" onchange="markCorrectIncorrectOption(this)"
					...
					<div class="col-xs-8">
						<form id="imageForm2">
							<input type="file" name="imagefield" id="imageId2" accept="image/*">
				...
				<div class="form-group">
					...
					<div class="col-xs-1">
						<div class="checkbox">
              <label>
                <input type="checkbox" id="inOptionChk3" value="2" onchange="markCorrectIncorrectOption(this)"
					...
					<div class="col-xs-8">
						<form id="imageForm3">
							<input type="file" name="imagefield" id="imageId3" accept="image/*">
				...
				<div class="form-group">
					...
					<div class="col-xs-1">
						<div class="checkbox">
              <label>
                <input type="checkbox" id="inOptionChk4" value="3" onchange="markCorrectIncorrectOption(this)"
					...
					<div class="col-xs-8">
						<form id="imageForm4">
							<input type="file" name="imagefield" id="imageId4" accept="image/*">
...
<script type="text/javascript">
	...
	function saveImageOption(previewid) {
		var data = new FormData($("#imageForm"+previewid)[0]);
		$.ajax({
